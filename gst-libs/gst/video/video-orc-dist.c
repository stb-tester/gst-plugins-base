    ...
    int p3, int p4, int p5, int n)
{
  ...
  var52.i = p4;
  /* 24: loadpb */
  var53 = (int) 0x00000080;     /* 128 or 6.32404e-322f */
  /* 29: loadpw */
  var55.i = p5;
  ...
  for (i = 0; i < n; i++) {
    ...
    /* 1: splitlw */
    {
      orc_union32 _src;
      _src.i = var47.x2[0];
      var57.x2[0] = _src.x2[1];
      var58.x2[0] = _src.x2[0];
    }
    {
      orc_union32 _src;
      _src.i = var47.x2[1];
      var57.x2[1] = _src.x2[1];
      var58.x2[1] = _src.x2[0];
    }
    /* 2: splitwb */
    {
      orc_union16 _src;
      _src.i = var58.x2[0];
      var59.x2[0] = _src.x2[1];
      var60.x2[0] = _src.x2[0];
    }
    {
      orc_union16 _src;
      _src.i = var58.x2[1];
      var59.x2[1] = _src.x2[1];
      var60.x2[1] = _src.x2[0];
    }
    /* 3: select0wb */
    {
      orc_union16 _src;
      _src.i = var57.x2[0];
      var61.x2[0] = _src.x2[0];
    }
    {
      orc_union16 _src;
      _src.i = var57.x2[1];
      var61.x2[1] = _src.x2[0];
    }
    /* 4: convubw */
    var62.x2[0] = (orc_uint8) var60.x2[0];
    var62.x2[1] = (orc_uint8) var60.x2[1];
    /* 5: convubw */
    var63.x2[0] = (orc_uint8) var59.x2[0];
    var63.x2[1] = (orc_uint8) var59.x2[1];
    /* 6: convubw */
    var64.x2[0] = (orc_uint8) var61.x2[0];
    var64.x2[1] = (orc_uint8) var61.x2[1];
    /* 8: mullw */
    var65.x2[0] = (var64.x2[0] * var48.x2[0]) & 0xffff;
    var65.x2[1] = (var64.x2[1] * var48.x2[1]) & 0xffff;
    /* 10: mullw */
    var66.x2[0] = (var63.x2[0] * var49.x2[0]) & 0xffff;
    var66.x2[1] = (var63.x2[1] * var49.x2[1]) & 0xffff;
    /* 11: addw */
    var67.x2[0] = var65.x2[0] + var66.x2[0];
    var67.x2[1] = var65.x2[1] + var66.x2[1];
    /* 13: mullw */
    var68.x2[0] = (var62.x2[0] * var50.x2[0]) & 0xffff;
    var68.x2[1] = (var62.x2[1] * var50.x2[1]) & 0xffff;
    /* 14: addw */
    var69.x2[0] = var67.x2[0] + var68.x2[0];
    var69.x2[1] = var67.x2[1] + var68.x2[1];
    /* 15: convhwb */
    var51.x2[0] = ((orc_uint16) var69.x2[0]) >> 8;
    var51.x2[1] = ((orc_uint16) var69.x2[1]) >> 8;
    /* 16: storew */
    ptr0[i] = var51;
    /* 17: select0lw */
    {
    ...
    /* 20: subw */
    var73.i = var72.i - var71.i;
    /* 22: mullw */
    var74.i = (var73.i * var52.i) & 0xffff;
    /* 23: convhwb */
    var75 = ((orc_uint16) var74.i) >> 8;
    /* 25: addb */
    var54 = var75 + var53;
    /* 26: storeb */
    ptr1[i] = var54;
    ...
    /* 28: subw */
    var77.i = var76.i - var71.i;
    /* 30: mullw */
    var78.i = (var77.i * var55.i) & 0xffff;
    /* 31: convhwb */
    var79 = ((orc_uint16) var78.i) >> 8;
    /* 32: addb */
    var56 = var79 + var53;
    /* 33: storeb */
    ptr2[i] = var56;
...
_backup_video_orc_convert_BGRA_I420 (OrcExecutor * ORC_RESTRICT ex)
{
  ...
  /* 21: loadpw */
  var52.i = ex->params[27];
  /* 24: loadpb */
  var53 = (int) 0x00000080;     /* 128 or 6.32404e-322f */
  /* 29: loadpw */
  var55.i = ex->params[28];
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      static const orc_uint8 bc[] = {
        ...
        14, 2, 128, 0, 0, 0, 14, 1, 128, 0, 0, 0, 14, 1, 127, 0,
        0, 0, 14, 1, 129, 0, 0, 0, 14, 2, 0, 0, 0, 0, 14, 2,
        8, 0, 0, 0, 16, 2, 16, 2, 16, 2, 16, 2, 16, 2, 20, 4,
        20, 4, 20, 1, 20, 4, 20, 4, 20, 2, 20, 2, 20, 2, 20, 4,
        20, 4, 20, 4, 20, 4, 20, 2, 20, 2, 20, 2, 21, 1, 198, 36,
        35, 4, 21, 1, 199, 38, 37, 35, 21, 1, 188, 39, 36, 21, 1, 150,
        40, 37, 21, 1, 150, 41, 38, 21, 1, 150, 42, 39, 21, 1, 89, 43,
        42, 24, 21, 1, 89, 32, 41, 25, 21, 1, 70, 33, 43, 32, 21, 1,
        89, 32, 40, 26, 21, 1, 70, 43, 33, 32, 21, 1, 158, 0, 43, 190,
        44, 43, 95, 44, 44, 22, 190, 45, 40, 98, 46, 45, 44, 89, 46, 46,
        27, 158, 34, 46, 33, 1, 34, 18, 190, 45, 42, 98, 46, 45, 44, 89,
        46, 46, 28, 158, 34, 46, 33, 2, 34, 18, 2, 0,
      };
      p = orc_program_new_from_static_bytecode (bc);
      ...
      orc_program_add_constant (p, 1, 0x00000081, "c5");
      orc_program_add_constant (p, 2, 0x00000000, "c6");
      orc_program_add_constant (p, 2, 0x00000008, "c7");
      orc_program_add_parameter (p, 2, "p1");
      orc_program_add_parameter (p, 2, "p2");
      orc_program_add_parameter (p, 2, "p3");
      orc_program_add_parameter (p, 2, "p4");
      ...
      orc_program_add_temporary (p, 2, "t15");

      orc_program_append_2 (p, "splitlw", 1, ORC_VAR_T5, ORC_VAR_T4, ORC_VAR_S1,
          ORC_VAR_D1);
      orc_program_append_2 (p, "splitwb", 1, ORC_VAR_T7, ORC_VAR_T6, ORC_VAR_T4,
          ORC_VAR_D1);
      orc_program_append_2 (p, "select0wb", 1, ORC_VAR_T8, ORC_VAR_T5,
          ORC_VAR_D1, ORC_VAR_D1);
      orc_program_append_2 (p, "convubw", 1, ORC_VAR_T9, ORC_VAR_T6, ORC_VAR_D1,
          ORC_VAR_D1);
      orc_program_append_2 (p, "convubw", 1, ORC_VAR_T10, ORC_VAR_T7,
          ORC_VAR_D1, ORC_VAR_D1);
      orc_program_append_2 (p, "convubw", 1, ORC_VAR_T11, ORC_VAR_T8,
          ORC_VAR_D1, ORC_VAR_D1);
      orc_program_append_2 (p, "mullw", 1, ORC_VAR_T12, ORC_VAR_T11, ORC_VAR_P1,
          ORC_VAR_D1);
      orc_program_append_2 (p, "mullw", 1, ORC_VAR_T1, ORC_VAR_T10, ORC_VAR_P2,
          ORC_VAR_D1);
      orc_program_append_2 (p, "addw", 1, ORC_VAR_T2, ORC_VAR_T12, ORC_VAR_T1,
          ORC_VAR_D1);
      orc_program_append_2 (p, "mullw", 1, ORC_VAR_T1, ORC_VAR_T9, ORC_VAR_P3,
          ORC_VAR_D1);
      orc_program_append_2 (p, "addw", 1, ORC_VAR_T12, ORC_VAR_T2, ORC_VAR_T1,
          ORC_VAR_D1);
      orc_program_append_2 (p, "convhwb", 1, ORC_VAR_D1, ORC_VAR_T12,
          ORC_VAR_D1, ORC_VAR_D1);
      orc_program_append_2 (p, "select0lw", 0, ORC_VAR_T13, ORC_VAR_T12,
          ORC_VAR_D1, ORC_VAR_D1);
      orc_program_append_2 (p, "shruw", 0, ORC_VAR_T13, ORC_VAR_T13, ORC_VAR_C7,
          ORC_VAR_D1);
      orc_program_append_2 (p, "select0lw", 0, ORC_VAR_T14, ORC_VAR_T9,
          ORC_VAR_D1, ORC_VAR_D1);
      orc_program_append_2 (p, "subw", 0, ORC_VAR_T15, ORC_VAR_T14, ORC_VAR_T13,
          ORC_VAR_D1);
      orc_program_append_2 (p, "mullw", 0, ORC_VAR_T15, ORC_VAR_T15, ORC_VAR_P4,
          ORC_VAR_D1);
      orc_program_append_2 (p, "convhwb", 0, ORC_VAR_T3, ORC_VAR_T15,
          ORC_VAR_D1, ORC_VAR_D1);
      orc_program_append_2 (p, "addb", 0, ORC_VAR_D2, ORC_VAR_T3, ORC_VAR_C3,
          ORC_VAR_D1);
      orc_program_append_2 (p, "select0lw", 0, ORC_VAR_T14, ORC_VAR_T11,
          ORC_VAR_D1, ORC_VAR_D1);
      orc_program_append_2 (p, "subw", 0, ORC_VAR_T15, ORC_VAR_T14, ORC_VAR_T13,
          ORC_VAR_D1);
      orc_program_append_2 (p, "mullw", 0, ORC_VAR_T15, ORC_VAR_T15, ORC_VAR_P5,
          ORC_VAR_D1);
      orc_program_append_2 (p, "convhwb", 0, ORC_VAR_T3, ORC_VAR_T15,
          ORC_VAR_D1, ORC_VAR_D1);
      orc_program_append_2 (p, "addb", 0, ORC_VAR_D3, ORC_VAR_T3, ORC_VAR_C3,
          ORC_VAR_D1);
#endif
